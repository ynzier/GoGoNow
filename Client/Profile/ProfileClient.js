    ...
    <Container>
      ...
      <Content noShadow>
        <Form style={styles.FormStyle}>
          <Text style={styles.TextHead}>ข้อมูลส่วนตัว</Text>
          <TextInput style={styles.InputStyle} placeholder="ชื่อ-นามสกุล" />
          <TextInput style={styles.InputStyle} placeholder="เบอร์" />
          <Text style={styles.TextTopic}>ข้อมูลผู้ที่ต้องการการดูแล</Text>
